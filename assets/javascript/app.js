...
//FCBAT7DCciFkcbxOqr0Yenvv9IqvDF4C

//Initial array of TV shows 
$(document).ready(function() {

    var topics = ["The Duke's of Hazzard", "Buck Rogers", "Mork and Mindy", "Miami Vice", "Cheers", "Magnum P.I.", "", "Knight Rider", "", "Three's Company", "", "Night Court", "Mama's Family"];  
  ...
  //on button click
  $(document).on('click', '.1980sTV', function() {
  
      //new variable will log the text data from each button
      var TVShows = $(this).html(); 
      // console.log(1980TV);
  
      var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + TVShows + "&api_key=FCBAT7DCciFkcbxOqr0Yenvv9IqvDF4C";
